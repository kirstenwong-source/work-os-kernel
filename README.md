...
1. **Control plane** - canonical meaning, schemas, source-of-truth registries, policies, and evidence rules.
2. **Evidence plane** - source logs, evidence packets, decision records, and append-only runtime outputs.
3. **Execution plane** - local commands that read the control plane, generate work products, and validate that outputs stay grounded.
